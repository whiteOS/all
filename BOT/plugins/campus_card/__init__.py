...
proxies = {'http': "http://10.152.36.46:8888",'https': "https://10.152.36.46:8888"}
cookie = {'JSESSIONID':'750BE3128A7C9B2FD7C0B67FD963C135'}
...
@charge.got("tran", prompt=f"请输入纯数字金额（元）\n30，50或者100")
